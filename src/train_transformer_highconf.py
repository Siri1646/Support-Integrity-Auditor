...
DATA_PATH = "data/high_confidence_tickets.csv"
OUTPUT_DIR = "models/distilbert_sia_highconf"
FINAL_MODEL_DIR = "models/distilbert_sia_highconf/final_model"
...
print("\nFinal Evaluation - High Confidence Weighted DistilBERT")
print("------------------------------------------------------")
...
print(f"\nHigh-confidence fine-tuned DistilBERT model saved to {FINAL_MODEL_DIR}")