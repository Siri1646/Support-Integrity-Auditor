# MARS-compliant transformer training
# Key fix: assigned priority is included as an input feature.
...
OUTPUT_DIR = "models/distilbert_sia_mars"
FINAL_MODEL_DIR = "models/distilbert_sia_mars/final_model"
...
df["text"] = (
    ...
    "Inferred severity: " + df["Inferred_Severity"].fillna("") + " " +
    "Severity score: " + df["Severity_Score"].round(2).astype(str) + " " +
    "Severity delta: " + df["Severity_Delta"].astype(str) + " " +
...
print("\nFinal Evaluation - MARS DistilBERT")
print("----------------------------------")
...
print(f"\nMARS DistilBERT model saved to {FINAL_MODEL_DIR}")